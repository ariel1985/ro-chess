...
# open JSON file to read cached moves
module_dir = os.path.dirname(__file__)  # get current directory
file_path = os.path.join(module_dir, "moves_cache.json")
...
class Game_Engine():
    def __init__(self, board_state):
        ...
        print "Rotem I am printing the game here..."
        print self.game
...
class AI():
    ...
    def make_move(self, node):
        ...
        return best_move
    # alpha beta make move
    # board_state is a FEN string
    # This is so 1
    
    def ab_make_move(self, board_state):
        print "chess_ai.ab_make_move the board_state FEN: \n%s" % board_state
        ...
        # best_move at this point stores the move with the highest heuristic
        # print ' best_move.algebraic_move: %s' % best_move.algebraic_move
